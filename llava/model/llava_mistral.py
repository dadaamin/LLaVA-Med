...
class LlavaConfig(MistralConfig):
    model_type = "llava-mistral"


class LlavaMistralModel(MistralModel):
    config_class = MistralConfig

    def __init__(self, config: MistralConfig, mm_vision_tower=None, mm_hidden_size=None):
    ...
    def forward(
        ...
        return super(LlavaMistralModel, self).forward(
...
AutoConfig.register("llava-mistral", LlavaConfig)
